export default async function videoFrameExtract(frame_rate, skip_val = 1, handleText = (_message) => {}){
    
    //alert("Video will be extracted into frames - This might take a bit!")
    const video = document.getElementById("process_vid") as HTMLVideoElement
    ...
    for(var i = 1; i < total_frames; i=i+skip_val){
        var new_time = (i/total_frames)*video.duration
